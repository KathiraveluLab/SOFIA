...
rm -rf "$ROOT_DIR/_build/node1_db" "$ROOT_DIR/_build/node2_db"
mkdir -p "$ROOT_DIR/_build/node1_db" "$ROOT_DIR/_build/node2_db"

echo "Starting SOFIA Node 1..."
erl -sname sofia_node1 -setcookie sofia_secret -mnesia dir '"_build/node1_db"' -noshell -pa $ROOT_DIR/_build/default/lib/*/ebin -pa $ROOT_DIR/_build/test/lib/*/ebin -eval "application:ensure_all_started(sofia)." &
NODE1_PID=$!
...
erl -sname sofia_node2 -setcookie sofia_secret -mnesia dir '"_build/node2_db"' -noshell -pa $ROOT_DIR/_build/default/lib/*/ebin -pa $ROOT_DIR/_build/test/lib/*/ebin -eval "application:set_env(sofia, gateway_port, 8081), application:ensure_all_started(sofia)." &
NODE2_PID=$!
...
erl -sname sofia_orchestrator -setcookie sofia_secret -noshell -pa $ROOT_DIR/_build/default/lib/*/ebin -pa $ROOT_DIR/_build/test/lib/*/ebin -eval "
